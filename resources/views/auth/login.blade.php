                    ...
                    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            Admin Login
                                ...
                                <input placeholder="name@example.com" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5" id="email" name="email" type="text">
                            </div>
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900">
                                Password
                                </label>
                                <input class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5" placeholder="••••••••" id="password" name="password" type="password">
                            </div>
